...
public:
    ...
    AbstractTemporallyExtendedModel & set_regularization(double) = 0;
    /**
     * Set the data to be used for learning the model. */
    AbstractTemporallyExtendedModel & set_data(const data_t &) = 0;
    /**
     * Set the horizon extension. This is the number of time steps the model is
     * extended into the past with each iteration. */
    AbstractTemporallyExtendedModel & set_horizon_extension(int n) = 0;
    /**
     ...
     * making predictions. */
    AbstractTemporallyExtendedModel & set_maximum_horizon(int n) = 0;
    /**
     * Optimize the model. */
    double optimize() = 0;
    /**
    ...
    double get_prediction(const data_t & data) = 0;
    /**
     * If in the inner loop the objective gradient is below this value
     * optimization is stopped. */
    AbstractTemporallyExtendedModel & set_gradient_threshold(double) = 0;
    /**
     * If in the inner loop the largest change of the parameters is below this
     * value optimization is stopped. */
    AbstractTemporallyExtendedModel & set_parameter_threshold(double) = 0;
    /**
     * If the number of iterations in the inner loop reaches this value
     * optimization is stopped. */
    AbstractTemporallyExtendedModel & set_max_inner_loop_iterations(int) = 0;
    /**
     * If the number of iterations in the outer loop reaches this value
     * optimization is stopped. */
    AbstractTemporallyExtendedModel & set_max_outer_loop_iterations(int) = 0;
    /**
     * If in the outer loop the likelihood changes less than this value
     * optimization is stopped. */
    AbstractTemporallyExtendedModel & set_likelihood_threshold(double) = 0;
};
